    ...
    function renderDecisions(data) {
        const html = (data.decisionRecommendations.recommendations || []).slice(0, 12).map(function(decision) {
            ...
            return [
                ...
                ui.badge(decision.priority, ui.priorityTone(decision.priority)),
                "</div>",
                "<div class='meta-row'><span>Urgency</span>" + ui.badge(decision.urgency_score, "warning") + "</div>",
                "<div class='meta-row'><span>Impact</span>" + ui.badge(decision.impact_score, "success") + "</div>",
                "<div class='meta-row'><span>Effort</span>" + ui.badge(decision.effort_score) + "</div>",
